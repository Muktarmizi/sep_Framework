...
public class CommonActions {
	...
	// common method for click ()
		...
		public static void mouseHoverAction(
		        WebDriver driver,
		        WebElement hoverActionElement,
		        WebElement elementNeedToBeClickFinally) {

		    try {
		        Actions actions = new Actions(driver);

		        actions.moveToElement(hoverActionElement).perform();

		        // Better than pause, but still simple
		        pause(1000);

		        actions.moveToElement(elementNeedToBeClickFinally)
		               .click()
		               .build()
		               .perform();
                
		        Loggers.logTheTest("Element selected from mouse hover action successfully");
		        ...
		        Loggers.logTheTest(
		                "Mouse hover failed for element: " + e.getMessage());

		        Assert.fail("Mouse hover action failed");
		    }
		}
...
//		}
		...
		public static void findYourNameFromTheTable (WebElement elementOfYourname, String expected) {
		   ...
		   //public static WebDriver driver1; // Make sure driver is assigned
...
//		    }
		...
		public void mouseHoverAction1(WebDriver driver, By hoverElement, By clickElement) {
		    Actions actions = new Actions(driver);
		    actions.moveToElement(driver.findElement(hoverElement))
		           .moveToElement(driver.findElement(clickElement))
		           .click()
		           .build()
		           .perform();
		}
